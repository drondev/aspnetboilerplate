...
namespace Abp.Tests.Domain.Entities
{
    public class Test_Entities
    {
        ...
        {
            var w1 = new Worker { Id = 5.ToGuid(), Name = "Halil ibrahim Kalkan" };
            var w2 = new Worker { Id = 5.ToGuid(), Name = "Halil ibrahim Kalkan" };
            ...
            var m1 = new Manager { Id = 5.ToGuid(), Name = "Halil ibrahim Kalkan", Title = "Software Architect" };

            Assert.True(m1.EntityEquals(w1), "Derived classes must be equal if their Ids are equal");

            var d1 = new Department { Id = 5.ToGuid(), Name = "IVR" };
