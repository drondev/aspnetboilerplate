...
namespace Abp.Localization
{
    public class MultiTenantLocalizationSource : DictionaryBasedLocalizationSource, IMultiTenantLocalizationSource
    {
        ...
        public List<string> GetStrings(Guid? tenantId, List<string> names, CultureInfo culture)
        {
        ...
        public List<string> GetStringsOrNull(Guid? tenantId, List<string> names, CultureInfo culture, bool tryDefaults = true)
        {
            var cultureName = culture.Name;
            var dictionaries = DictionaryProvider.Dictionaries;
