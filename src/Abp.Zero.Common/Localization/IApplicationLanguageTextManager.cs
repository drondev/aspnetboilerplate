...
namespace Abp.Localization
{
    ...
    public interface IApplicationLanguageTextManager
    {
        ...
        string GetStringOrNull(Guid? tenantId, string sourceName, CultureInfo culture, string key, bool tryDefaults = true);
        ...
        /// <param name="tryDefaults">True: fallbacks to default languages if can not find in given culture</param>
        List<string> GetStringsOrNull(Guid? tenantId, string sourceName, CultureInfo culture, List<string> keys, bool tryDefaults = true);
        ...
        Task UpdateStringAsync(Guid? tenantId, string sourceName, CultureInfo culture, string key, string value);
    }
}
