...
namespace Abp.Webhooks
{
    public class DefaultWebhookSender : DomainService, IWebhookSender
    {
        ...
        [UnitOfWork]
        protected virtual async Task StoreResponseOnWebhookSendAttemptAsync(Guid webhookSendAttemptId, Guid? tenantId, HttpStatusCode? statusCode, string content)
        {
        ...
        [UnitOfWork]
        protected virtual void StoreResponseOnWebhookSendAttempt(Guid webhookSendAttemptId, Guid? tenantId, HttpStatusCode? statusCode, string content)
        {
